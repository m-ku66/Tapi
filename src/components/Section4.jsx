...
const Section4 = () => {
    ...
    const overlayStyle1 = "block absolute z-10 flex justify-center items-center w-full h-full bg-black/[0.8]"
    ...
    return (
        <>
            <div className={overlayState ? overlayStyle1 : overlayStyle2}>
                <div className='flex flex-col justify-center px-[5%] pt-[5%] w-[60%] h-[60%] bg-stone-900'>
                    <div>
                        <h1 className='mb-[5%] text-white default-text font-[600] text-[3rem] leading-tight text-center'>MESSAGE SENT SUCCESSFULLY</h1>
                        <p className='text-white default-text font-[200] text-[1.5rem] mb-[5%] text-center'>We've recieved your message and will get back to you as soon as we're available. Thank you fo your inquiry.</p>
            ...
            <div className='relative flex pt-[10%] px-[4%] w-full h-screen bg-black'>
                <div data-aos="fade-right" data-aos-duration="1000" className='w-[480px] h-fit'>
                    <h1 className='mb-[5%] text-white default-text font-[600] text-[3rem] leading-tight'><span className='text-rose-600'>CONTACT</span> US</h1>
                    <p className='text-white default-text font-[200] text-[1rem] mb-[5%]'>For any further inquiries relating Tapi and its specs or investment, either fill out this form or contact us directly at:</p>
                    <p className='text-white default-text font-[200] text-[0.8rem]'>Gmail | Other Contact Info</p>
                </div>
                <div className='absolute right-[1%] pr-[8%] w-[40%] h-fit'>
